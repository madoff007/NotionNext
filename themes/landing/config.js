const CONFIG = {
  ...
  LANDING_FEATURES_HEADER_2: '跨境超级个体+智慧供应链未来方案',
  LANDING_FEATURES_HEADER_2_P: '在Notion笔记中管理文章数据，+将其渲染成网页排版，通过Vercel等第三方平台将您的网站发布到全球。',
  LANDING_FEATURES_CARD_1_TITLE: '个人卖家/初创团队',
  LANDING_FEATURES_CARD_1_P: '有意通过电商渠道直接面向海外客户销售产品的工厂，需要电商专业知识来弥补传统销售模式的不足。',
  LANDING_FEATURES_CARD_2_TITLE: '急需转型的制造业工厂',
  LANDING_FEATURES_CARD_2_P: '希望借助系统化的指导在跨境电商领域入门，并逐步成长为成熟卖家或团队。',
  LANDING_FEATURES_CARD_3_TITLE: '高等院校/培训机构',
  LANDING_FEATURES_CARD_3_P: '希望为学生提供跨境电商技能培训，或为内部团队搭建完整的跨境电商知识体系，增强学生和员工的市场竞争力。',
  ...
  LANDING_TESTIMONIALS_NICKNAME: 'eComNO.1'
  LANDING_TESTIMONIALS_ID: 'Ryan`Log 站长',
  LANDING_TESTIMONIALS_SOCIAL_NAME: '@eComNO.1',
  ...
  LANDING_POST_REDIRECT_URL: process.env.NEXT_PUBLIC_POST_REDIRECT_URL || 'https://ecomno.one', // 重定向网站地址
  ...
  LANDING_PRICING_1_URL: 'https://ecomno.one',
  ...
  LANDING_PRICING_2_URL: 'https://ecomno.one',
  ...
  LANDING_PRICING_3_URL: 'https://ecomno.one',
